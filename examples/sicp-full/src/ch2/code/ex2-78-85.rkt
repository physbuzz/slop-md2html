...
;; apply-generic for problems 2.81 onwards
(define (apply-generic op . args)
  (let ((type-tags (map type-tag args)))
    (let ((proc (get op type-tags)))
      (if proc
...
(newline) (display "Testing for 2.77") (newline)
(magnitude a)
(display a)

(newline)
(newline) (display "Testing for 2.78") (newline)
...
(newline) (display "Testing coercion") (newline)
(apply-generic 'add (make-complex-from-real-imag 1 1) 
